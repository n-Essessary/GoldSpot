...
SAMPLE_TITLES = [
    "Thunderfury [US - Classic] - Alliance",
    "Doomhowl [US - Hardcore] - Horde",
    "Pagle [US - Classic] - Horde",
    "Noggenfogger [EU - Classic] - Alliance",
    "Soulseeker [EU - Hardcore] - Horde",
    "Thunderstrike [EU - Anniversary] - Alliance",
    "Maladath [AU - Anniversary] - Horde",
    "Penance [AU - Season of Discovery] - Alliance",
    "Shadowstrike [AU - Season of Discovery] - Horde",
    "Hydraxian Waterlords [EU - Classic] - Alliance",
]
...
@pytest.mark.asyncio
async def test_batch2_servers_resolve_without_warning(monkeypatch, caplog):
